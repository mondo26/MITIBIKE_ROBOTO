...
public class TestPlayerController : MonoBehaviour
{
    ...
    [SerializeField, Header("ロボットが稼働停止した際のマテリアル")]
    ...
    //[SerializeField, Header("段差を昇る為のレイを飛ばす位置")]
    //private Transform stepRay;
    //[SerializeField, Header("レイを飛ばす距離")]
    //private float stepDistance = 0.5f;
    //[SerializeField, Header("昇れる段差")]
    //private float stepOffset = 0.3f;
    //[SerializeField, Header("昇れる角度")]
    //private float slopeLimit = 65f;
    //[SerializeField, Header("昇れる段差の位置から飛ばすレイの距離")]
    //private float slopeDistance = 1.0f;
    ...
    private RaycastHit rayHit, stepHit;
    private Image image;
    ...
    void StopMove()
    {
        ...
        Destroy(GetComponent<TestPlayerController>());          // このコンポーネント削除
        Destroy(UI);                                            // UIを削除
